...
import com.li.core.util.hibernate.jdbc.util.FormatStyle;
...
public class SqlLog {
	...
	//是否打印log
	private static final String islog = properties.getProperty("log4j.li.sql.log");
	//是否格式化
	private static final String farmat = properties.getProperty("log4j.li.sql.format");
